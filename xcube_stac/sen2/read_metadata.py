...
def angles_from_metadata(xml_dict: dict) -> xr.DataArray:
    """Gets the sun and viewing angle values from Sentinel-2 xml granule metafile.
    ...
    ----------
    xml_dict : dict
        containing metadata, converted from xml granule metafile
    ...
    """
    geocoding = xml_dict["n1:Level-2A_Tile_ID"]["n1:Geometric_Info"]["Tile_Geocoding"]
    ...
    ULX = float(geocoding["Geoposition"][0]["ULX"])
    ULY = float(geocoding["Geoposition"][0]["ULY"])
